...
const StateSkeleton = ({
  ...
  <div className="mt-16 flex w-full flex-col items-center justify-center sm:mt-36">
    ...
    {button && (
      <Button className="paragraph-medium mt-5 min-h-11.5 rounded-lg bg-primary-500 px-4 py-3 text-light-900 hover:bg-primary-500" render={<Link href={button.href} />} nativeButton={false}>
        {button.text}
      </Button>
    )}
  </div>
